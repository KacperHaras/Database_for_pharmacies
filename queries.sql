...
INSERT INTO pracownicy (imie, nazwisko, data_zatrudnienia, plec, stanowisko, pojazd_id) VALUES ('Maria', 'Dąbrowski', '2020-06-06', 'K', 'Magister farmacji', 4);
INSERT INTO pracownicy (imie, nazwisko, data_zatrudnienia, plec, stanowisko, pojazd_id) VALUES ('Maria', 'Wójcik', '2014-12-25', 'K', 'Magister farmacji', 5);
INSERT INTO pracownicy (imie, nazwisko, data_zatrudnienia, plec, stanowisko, pojazd_id) VALUES ('Małgorzata', 'Kowalczyk', '2021-01-01', 'K', 'Magister farmacji', null);
INSERT INTO pracownicy (imie, nazwisko, data_zatrudnienia, plec, stanowisko, pojazd_id) VALUES ('Ewa', 'Kamiński', '2014-09-01', 'K', 'Magister farmacji', 6);
INSERT INTO pracownicy (imie, nazwisko, data_zatrudnienia, plec, stanowisko, pojazd_id) VALUES ('Ewa', 'Zieliński', '2014-01-01', 'K', 'Technik farmacji', 3); --8
INSERT INTO pracownicy (imie, nazwisko, data_zatrudnienia, plec, stanowisko, pojazd_id) VALUES ('Elżbieta', 'Nowak', '2014-05-01', 'K', 'Technik farmacji', null);
...
INSERT INTO pracownicy (imie, nazwisko, data_zatrudnienia, plec, stanowisko, pojazd_id) VALUES ('Małgorzata', 'Baran', '2021-03-01', 'K', 'Technik farmacji', null);
INSERT INTO pracownicy (imie, nazwisko, data_zatrudnienia, plec, stanowisko, pojazd_id) VALUES ('Barbara', 'Dąbrowski', '2014-08-01', 'K', 'Technik farmacji', 4);
...
INSERT INTO pracownicy (imie, nazwisko, data_zatrudnienia, plec, stanowisko, pojazd_id) VALUES ('Zofia', 'Szymański', '2021-12-14', 'K', 'Technik farmacji', null);
...
INSERT INTO pracownicy (imie, nazwisko, data_zatrudnienia, plec, stanowisko, pojazd_id) VALUES ('Wiktoria', 'Nowak', '2014-05-01', 'K', 'Technik farmacji', 6); -- 20
...
INSERT INTO pracownicy (imie, nazwisko, data_zatrudnienia, plec, stanowisko, pojazd_id) VALUES ('Stanisław', 'Kucharski', '2017-01-01', 'M', 'Kierowca', 2);
INSERT INTO pracownicy (imie, nazwisko, data_zatrudnienia, plec, stanowisko, pojazd_id) VALUES ('Jan', 'Mączka', '2014-01-01', 'M', 'Koordynator', 7);
...
INSERT INTO pacjenci (imie, nazwisko, pesel, wiek) VALUES ('Jan', 'Apostoł', '17895023461', 50);
...
INSERT INTO pacjenci (imie, nazwisko, pesel, wiek) VALUES ('Michał', 'Michalski', '13456827904', 19);
...
BEGIN
    IF EXISTS (
        ...
        AND (
            ...
            OR (NEW.data_zakonczenia BETWEEN data_rozpoczecia AND data_zakonczenia)
            OR (data_rozpoczecia BETWEEN NEW.data_rozpoczecia AND NEW.data_zakonczenia)
        )
        AND NEW.rezerwacja_id != rezerwacja_id
    ) THEN
        RAISE EXCEPTION 'W tym terminie pojazd jest zajety.\n\tSprawdz dostepnosc pojazdu w innym terminie.';
    END IF;
    RETURN NEW;
END;
$$ LANGUAGE 'plpgsql';

CREATE TRIGGER is_date_free
BEFORE INSERT OR UPDATE ON rezerwacje
FOR EACH ROW EXECUTE PROCEDURE check_date();


--widok na receptye i pacjenta oraz rachunek jako sume ceny lekow
...
--przykladowy select
SELECT imie, nazwisko, pesel, kod_recepty, rachunek FROM podsumowanie_recepty WHERE apteka_realizujaca = 1;


-- wszystkie rezerwacje pojazdow
...
--przykladowy select
SELECT imie, nazwisko, stanowisko, marka, rejestracja, data_rozpoczecia, data_zakonczenia from podsumowanie_rezerwacji
where apteka_id=2
...
--przykladowy select
SELECT imie, nazwisko, plec, data_zatrudnienia, stanowisko from podsumowanie_pracownikow
where apteka_id=2

--informacje o stanie magazynow
CREATE OR REPLACE VIEW podsumowanie_magazynu AS
SELECT magazyny.apteka_id, CONCAT(pracownicy.imie,' ',pracownicy.nazwisko) as osoba_nadzorujaca, leki.nazwa, magazyny_leki.ilosc, leki.cena FROM magazyny
JOIN magazyny_leki
...
select * from podsumowanie_magazynu where podsumowanie_magazynu.apteka_id=1